        ...
        <div className='departmentsContainer__cards'>
          <div className='departmentsContainer__cardsLeft'>
            <div
              ...
              onClick={() => history.push('department/2')}
            ...
            <div
              className='departmentsContainer__card'
              onClick={() => history.push('department/1')}
            ...
            <div
              className='departmentsContainer__card'
              onClick={() => history.push('department/3')}
          ...
          <div className='departmentsContainer__cardsRight'>
            <div
              className='departmentsContainer__card'
              onClick={() => history.push('department/4')}
            ...
            <div
              className='departmentsContainer__card'
              onClick={() => history.push('department/5')}
              style={{ borderLeft: '4px solid #DBCF04' }}
            >
            ...
            <div
              onClick={() => history.push('department/6')}
              className='departmentsContainer__card'
